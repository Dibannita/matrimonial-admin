...
@Component({
  selector: 'app-all-to-let',
  templateUrl: './all-to-let.component.html',
  styleUrls: ['./all-to-let.component.scss']
})
export class AllToLetComponent implements OnInit {
  // Admin Base Data
  adminId: string;
  role: string;
...
private getAllCategory() {
    ...
    const filter: FilterData = {
      filter: {...this.filter,...{postType: "to_let"}} ,
      pagination: null,
      select: mSelect,
      sort: { createdAt: -1 },
    };
