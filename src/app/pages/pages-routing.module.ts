...
const routes: Routes = [
  {
    ...
    children: [
      ...
      //   path: 'to-let',
      //   loadChildren: () =>
      //     import('./to-let/to-let.module').then((m) => m.ToLetModule),
      // },
...

      {
        ...
        loadChildren: () =>
          import('./contact-request/contact-request.module').then(
            (m) => m.ContactRequestModule
          ),
      },
      // {
      //   path: 'offer',
      ...
      //   loadChildren: () =>
      //     import('./discount-percent/discount-percent.module').then(
      //       (m) => m.DiscountPercentModule
      //     ),
      // },
      // {
      //   path: 'additionl-page',
      //   loadChildren: () =>
      //     import('./additionl-page/additionl-page.module').then(
      //       (m) => m.AdditionlPageModule
      //     ),
      // },
      // {
      //   path: 'address',
...

      {
        path: 'add-biodata',
        loadChildren: () =>
          import('./matrimonial/add-biodata/add-biodata.module').then(
            (m) => m.AddBiodataModule
          ),
      },
    ],
  },
