...
export class ExpectedPartnerComponent implements OnInit, OnDestroy {
  ...
  onFormSubmit() {
    console.log('ddddddd', this.dataForm.value);
    if (this.dataForm.valid) {
      ...
      if (this.id) {
        ...
        setTimeout(() => {
          ...
          this.router.navigate(['/add-biodata/pledge'], {
  ...
  private getProductById() {
    const select =
      'partnerMaritalStatus partnerOccupation partnerGun partnerFinancial partnerArea partnerMaritalStatus partnerComplexion partnerWeight partnerHeight partnerAge';
