...
export class ReplyContactRequestComponent implements OnInit {
   ...
   */
  private setFormData() {
    this.dataForm.patchValue({status: this.contactRequest.status, guardianName: this.contactRequest.guardianName, guardianPhoneNo: this.contactRequest.guardianPhoneNo});
  }
  ...
  private getContactRequestByContactRequestId() {
    this.contactRequestService.getContactRequestByContactRequestId(this.id)
      .subscribe(res => {
  ...
  private editContactRequest(data: ContactRequest) {
    ...
    this.contactRequestService.editContactRequest(data)
      .subscribe(res => {
